...
export interface GsGifList {
  gifs: any[];
}

/**
 * This is a dumb component once the component will not handle internal
 * state and StencilJS has a problem when the parent's componentDidUpdate()
 * lifecycle method is triggered for class components: the method is fired
 * before the children (this component) has rendered the elements
 * so it's not possible to fetch the HTML element height, for example
 *
 * @param props
 */
export const GsGifList: FunctionalComponent<GsGifList> = ({ gifs }) => {
